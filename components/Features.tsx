...
const features = [
  ...
  {
    titleKey: "secureLegacyTitle",
    descKey: "secureLegacyDesc",
  ...
  {
    titleKey: "digitalInnovationTitle",
    descKey: "digitalInnovationDesc",
    ...
    <section id="pillars" className="section scroll-mt-24 border-y border-line bg-canvas-ivory">
      <div className="container-page">
        <div className="mx-auto mb-14 max-w-2xl text-center">
          ...
          <h2 className="heading-lg mt-4 text-ink">{t("features.title")}</h2>
          <div className="mx-auto mt-6 h-1 w-20 rounded-full bg-gold" aria-hidden="true" />
          <p className="lede mt-6">{t("features.lede")}</p>
        </div>
        ...
        <ul className="grid gap-6 md:grid-cols-3 lg:gap-8">
          {features.map((item, index) => (
            ...
            >
              ...
              <h3 className="mb-3 text-2xl font-bold tracking-[-0.03em] text-ink">
