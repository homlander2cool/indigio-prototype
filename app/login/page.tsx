...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#f4efe8] px-4 py-10 sm:px-6 lg:px-8">
      <div className="grid w-full max-w-6xl overflow-hidden rounded-[36px] border border-[#d7cfbf] bg-white shadow-[0_40px_140px_rgba(11,35,64,0.16)] lg:grid-cols-[1.12fr_0.88fr]">
        <div className="relative hidden overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(212,175,55,0.28),transparent_30%),linear-gradient(135deg,#071a2b_0%,#0c2544_38%,#112b4d_100%)] p-10 text-white lg:flex lg:flex-col lg:justify-between">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(255,255,255,0.16),transparent_18%),radial-gradient(circle_at_20%_80%,rgba(212,175,55,0.15),transparent_22%)]" />

          <div className="relative z-10">
            <div className="mb-10 flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-[#d4af37] to-[#f6e7a4] text-base font-black text-[#0b2340] shadow-[0_0_30px_rgba(212,175,55,0.42)]">
                I
              </div>
              <div>
                <div className="text-[10px] font-semibold uppercase tracking-[0.34em] text-[#f2d686]">Private bank</div>
                <div className="text-sm font-black tracking-[0.3em]">INDIGIO</div>
              </div>
            </div>
          ...
          <div className="relative z-10 space-y-4">
            {trustPoints.map((item, index) => (
              <div
                key={item}
                className={`portal-card flex items-center gap-3 p-3.5 transition duration-300 hover:-translate-y-0.5 hover:border-[#f2d686]/40 ${index === 0 ? "float-slow" : ""}`}
              >
        ...
        <div className="bg-[#f8f5f0] p-6 sm:p-8 lg:p-12">
          <div className="mb-8 flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] text-[#102033] sm:text-[2.35rem]">Sign in</h2>
            </div>
          ...
          <div className="space-y-3">
            ...
            <Link href="/kyc" className="gold-button shine w-full justify-center rounded-2xl bg-[#0b2340] px-6 py-3.5 text-white hover:bg-[#102d4f]">
